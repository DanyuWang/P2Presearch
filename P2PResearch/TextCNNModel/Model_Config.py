...
class TextConfig():
    ...
    train_filename = './data/Tagged_Data_Train.csv'  # train data
    test_filename = './data/Untagged_Data_Predict.csv'  # test data
    val_filename = './data/Tagged_Data_Val.csv'  # validation data
